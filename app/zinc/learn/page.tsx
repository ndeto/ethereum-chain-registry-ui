...
export const metadata = {
  title: 'Learn — Zinc Theme',
  description: 'Docs, specs and references styled in Tailwind Zinc.'
}

export default function ZincLearnPage() {
  return (
    <main className="min-h-screen bg-background p-6">
      <div className="mx-auto max-w-5xl grid gap-6">
        <div className="text-center space-y-2">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-secondary/50 border border-zinc-800">
            <BookOpen className="h-4 w-4 text-zinc-200" />
            <span className="text-xs text-zinc-400 font-medium">Learn & References</span>
          </div>
          <h1 className="text-3xl font-semibold">ERC‑7785: Reference Hub</h1>
          <p className="text-sm text-zinc-400">Key specs, resolver docs, and interop resources mentioned across the app.</p>
        </div>

        <Card className="border border-zinc-800 bg-zinc-900/50 shadow-none">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Hash className="h-5 w-5 text-zinc-200" />
        ...
        <Card className="border border-zinc-800 bg-zinc-900/50 shadow-none">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Link2 className="h-5 w-5 text-zinc-200" />
              ENS Resolvers
            </CardTitle>
